...
class TwoLayerNet(object):
  ...
  def loss(self, X, y=None, reg=0.0):
    ...
    # shape (N, C).                                                             #
    #############################################################################
    layer1_output = X.dot(W1) + b1
    layer1_output_activation = np.maximum(layer1_output, 0)
    scores = layer1_output_activation.dot(W2) + b2
    #############################################################################
    #                              END OF YOUR CODE                             #
    #############################################################################
    ...
    prob /= N
    dW2 = layer1_output_activation.T.dot(prob)
